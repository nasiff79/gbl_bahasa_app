...
class Practice4Quiz {
  ...
  var imageText = ["Speak", "Give", "Go", "Eat", "Drink"];
  ...
  var choices = [
    ["Beri", "Cakap", "Pergi", "Makan"],
    ["Lari", "Beri", "Tulis", "Minum"],
    ["Pergi", "Jalan", "Lari", "Tulis"],
    ["Minum", "Tidur", "Makan", "Jalan"],
    [
      "Tulis",
      "Jalan",
      "Tidur",
  ...
  var correctAnswers = ["Cakap", "Beri", "Pergi", "Makan", "Minum"];
}

double percent = questionNumber / quiz.correctAnswers.length;

// Intro Page
class Practice4Intro extends StatelessWidget {
  @override
